...
var commandHelps = []CommandHelp{
	...
	},
	{
		...
		LongDesc:  "Switches to the specified user account.",
		Syntax:    "user select <username>",
		Arguments: []string{"username: The name of the user to switch to"},
	...
	},
	{
		...
		LongDesc:  "Switches to the specified mindmap or exits the current mindmap if no name is provided.",
		Syntax:    "mindmap select [mindmap_name]",
		Arguments: []string{"mindmap_name: (Optional) The name of the mindmap to switch to"},
	...
	},
	{
		Scope:     "system",
		Operation: "undo",
		ShortDesc: "Undo the last operation",
		LongDesc:  "Undoes the last operation performed in the current mindmap.",
		Syntax:    "system undo",
		Examples:  []string{"system undo"},
	},
	{
		Scope:     "system",
		Operation: "redo",
		ShortDesc: "Redo the last undone operation",
		LongDesc:  "Redoes the last operation that was undone in the current mindmap.",
		Syntax:    "system redo",
		Examples:  []string{"system redo"},
	},
}
